    ...
    <section className="py-24 bg-stone-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <Card padding="md" className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-bold text-stone-200 text-xs sm:text-sm">Store Address</h4>
                  <p className="text-stone-400 text-xs mt-1">{STORE_DETAILS.address}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <span className="text-xl">🕒</span>
                <div>
                  <h4 className="font-bold text-stone-200 text-xs sm:text-sm">Working Hours</h4>
                  {STORE_DETAILS.hours.map((h, index) => (
                    <p key={index} className="text-stone-400 text-xs mt-1">
          ...
          <div className="w-full h-80 sm:h-96 rounded-[2rem] overflow-hidden border border-stone-800 shadow-xl bg-stone-950">
            <iframe
