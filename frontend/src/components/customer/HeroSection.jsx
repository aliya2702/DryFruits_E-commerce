      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Headline */}
            <h1 className="text-4xl sm:text-6xl font-black text-stone-900 dark:text-stone-100 leading-tight">
              {HERO_DATA.headline}{" "}
          ...
          >
            ...
            <div className="relative rounded-[2.5rem] overflow-hidden border border-amber-500/15 shadow-2xl shadow-amber-900/20 max-w-sm w-full">
              ...
              <div className="absolute bottom-4 left-4 right-4 glass-card p-3">
                ...
                <p className="text-stone-500 dark:text-stone-400 text-xs mt-0.5">Customized hampers for every occasion</p>
              </div>
            </div>
