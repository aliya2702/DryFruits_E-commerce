          ...
          {REVIEWS.map((review) => (
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-stone-700 dark:text-stone-300 text-xs sm:text-sm italic leading-relaxed">
                  "{review.review}"
                </p>
              </div>
              ...
              <div className="flex items-center gap-3 mt-6 pt-6 border-t border-stone-200 dark:border-stone-850">
                ...
                <div>
                  <h4 className="font-bold text-stone-800 dark:text-stone-200 text-xs sm:text-sm">{review.name}</h4>
